...
export default class MainMenuGuestScreen extends React.Component {
  ...
  render() {
    ...
    return (
      <ScrollView>
        ...
        <TouchableOpacity style={{marginTop:5}} onPress={()=>this.props.navigation.navigate('Guestcpulist')}>
        ...
        <TouchableOpacity style={{marginTop:5}} onPress={()=>this.props.navigation.navigate('Guestgpulist')}>
        <Text style={{fontSize:20,fontWeight:'bold',textAlign:'center',color:'white'}}>
          View GPU Product
        </Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity style={{marginTop:5}} onPress={()=>this.props.navigation.navigate('Guestramlist')}>
        <Text style={{fontSize:20,fontWeight:'bold',textAlign:'center',color:'white'}}>
          View RAM Product
        </Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity style={{marginTop:5}} onPress={()=>this.props.navigation.navigate('Guestpcsetlist')}>
        <Text style={{fontSize:20,fontWeight:'bold',textAlign:'center',color:'white'}}>
          PC set
        </Text>
        </TouchableOpacity>
